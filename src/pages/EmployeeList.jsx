                                    ...
                                    <tr
                                        ...
                                        {headerGroup.headers.map(
                                            (column, columnIndex) => (
                                                <th
                                                    tabIndex={0}
                                                    className="border-solid border-2 border-green-800 bg-custom-500 text-white py-1 pl-2 w-[100px] lg:w-[130px] 2xl:w-[300px] text-xs lg:text-base whitespace-nowrap"
                                                    key={columnIndex}
